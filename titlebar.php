...
<head>
  ...
  <script>
    // Compatibility shim for the ancient jquery.tooltip.js plugin (2008 era),
    // which does feature detection like $.browser.msie and was written for jQuery <1.9.
    // jQuery 3+ removed $.browser entirely. This prevents the "Cannot read properties of undefined (reading 'msie')" error.
